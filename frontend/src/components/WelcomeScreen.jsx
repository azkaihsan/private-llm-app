  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 pb-4">
      <div className="flex flex-col items-center max-w-2xl w-full">
        ...
        {/* Greeting */}
        <h1 className="text-xl sm:text-[28px] font-semibold mb-6 sm:mb-8 text-center" style={{ color: 'var(--text-primary)' }}>
          ...
          {suggestions.map((suggestion, index) => {
            ...
            return (
              <button
                ...
                className="flex items-start gap-3 p-3 sm:p-3.5 rounded-xl border border-white/10 hover:bg-white/5 transition-all duration-200 text-left group"
                data-testid={`suggestion-${index}`}
              >
                <div className="mt-0.5 text-neutral-500 group-hover:text-neutral-300 transition-colors shrink-0">
                  <Icon size={18} />
                </div>
